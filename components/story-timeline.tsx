...
export function StoryTimeline() {
  ...
  return (
    <div ref={sectionRef} className={`relative mx-auto max-w-3xl ${hasStarted ? 'story-timeline-active' : ''}`}>
      <div className="story-timeline-track absolute left-6 top-4 bottom-4 w-px bg-accent/20 sm:left-8" aria-hidden>
        ...
        {storyMilestones.map((item, idx) => (
          <AnimatedSection key={item.year} direction="up" delay={idx * 120}>
            <div className="relative pl-20">
              <div
                className="story-timeline-node absolute left-0 top-1 flex h-12 w-12 items-center justify-center rounded-full border-2 border-accent bg-card shadow-[0_0_16px_rgba(255,140,66,0.25)]"
              ...
              <div className="rounded-2xl border border-border bg-card/80 p-6 glow-card">
